...
namespace Mavryck_System.Tests.VivclimaTests_mavryck
{
    ...
    public class ClimateRisk_VivclimaTest_mavryck : Base
    {
        ...
        {
            var Test = Extent.CreateTest("Climate Risk : Verify The Header Requirments");
            int step = 0;
        ...
        {
            var Test = Extent.CreateTest("Climate Risk: Verify The Hover Feature");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Climate Risk : Verify The Page Titles With Tooltips");
        ...
        [Test]
        public async Task Vivclima_Verify_GridResizing_OF_ClimateRisk()
        {
            var Test = Extent.CreateTest("Climate Risk : Verify The Grid Resizing Of Climate Risk");
