...
namespace Mavryck_System.Tests.VivclimaTests_mavryck
{
    ...
    public class Andon_OptimaRes_Test_mavryck : Base
    {
        ...
        [Test]
        public async Task Andon_Verify_PageTitles()
        {
            var Test = Extent.CreateTest("Andon : Verify The Page Title");
        ...
        [Test]
        public async Task Andon_Verify_Graph1_Chart()
        {
        ...
        [Test]
        public async Task Andon_Verify_Graph2_Chart()
        {
        ...
        [Test]
        public async Task Andon_Verify_AnomaliesInCarbonAndMaterials_Chart()
        {
