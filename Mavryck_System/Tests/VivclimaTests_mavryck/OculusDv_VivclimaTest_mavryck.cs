...
namespace Mavryck_System.Tests.VivclimaTests_mavryck
{
    ...
    public class OculusDv_VivclimaTest_mavryck : Base
    {
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Total Carbox Tax Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Map Resizing Of Total Carbox Tax Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The S Curve Total Carbox Tax Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Map Resizing Of S Curve Total Carbox Tax Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Total Carbox Emission Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Map Resizing Of Total Carbox Emission Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The S Curve Of Total Carbon Emission Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Map Resizing Of S Curve Of Total Carbon Emission Map");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Tornado Emission Comparison Chart");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Map Resizing Of Tornado Emission Comparison Chart");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Total Emission Chart");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Map Resizing Of Total Emission Chart");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        [Test]
        public async Task Viclima_Verify_EmissionActivityFullFlow_Chart_Of_OculusDV()
        {
            var Test = Extent.CreateTest("Oculus DV: Verify The Emission Activity Full Flow Chart");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
            ...
            var vivclima = "vivclima";
            var vivclimaTitle = "Vivclima";
            var title = "Emission Activity Full Flow";
            ...
            try
            {
                ...
                Test.Log(Status.Info, $"Step {++step}: Verify the <b> Emission Activity Full Flow</b> is visible");
                Assert.True(await VivclimaPage_mavryck.VerifyEmissionActivityFullFlowChartIsDisplaying());

                Test.Log(Status.Info, $"Step {++step}: Verify the Map  Title: <b>Emission Activity Full Flow</b> is displaying");
                Assert.True(await VivclimaPage_mavryck.VerifyChartNameIsDisplaying(title));
