...
namespace Mavryck_System.Tests.VivclimaTests_mavryck
{
    ...
    public class AirQuality_VivclimaTest_mavryck : Base
    {
        ...
        {
            var Test = Extent.CreateTest(" Air Quality : Verify The Header Requirments");
            int step = 0;
        ...
        {
            var Test = Extent.CreateTest("Air Quality: Verify The Hover Feature");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
        ...
        {
            var Test = Extent.CreateTest("Air Quality : Verify The Page Titles With Tooltips");
