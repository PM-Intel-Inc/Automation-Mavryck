...
{ 
    internal class AbacusPage_mavryck : Base
    {
        ...
        public async Task<bool> VerifyRollingAverage()
        {
            await ScrollToElement(page, "//h3[text()='Rolling Average']");
            return await WaitForElementVisible(page, "//div[@id='rollingAvgDiv']", 120000);
        }
        public async Task<bool> VerifyPolynomialTrendLine()
        {
            await ScrollToElement(page, "//h3[text()='Polynomial Trend Line']");
            return await WaitForElementVisible(page, "//div[@id='PolynomialDiv']", 120000);
        }
        public async Task<bool> VerifyLinearTrendLine()
        {
            await ScrollToElement(page, "//h3[text()='Linear Trend Line']");
            return await WaitForElementVisible(page, "//div[@id='LinearTrendDiv']", 120000);
        }
        ...
        public async Task<bool> VerifyTaskOverRuns()
        {
            return await WaitForElementVisible(page, "//div[@id='taskOverrunGraph']", 120000);
        }

        public async Task<bool> VerifyNumberOfDelayEvents()
        {
            return await WaitForElementVisible(page, "//div[@id='delayEventsGraph']", 120000);
        }
        public async Task<bool> VerifyZScoreAnomalyDetection()
        {
            await ScrollToElement(page, "//h3[text()='Z-Score Anomaly Detection']");
            return await WaitForElementVisible(page, "//div[@id='ZScoreDataDiv']", 120000);
        }

        public async Task<bool> VerifyIsolationForestAnomalyDetection()
        {
            await ScrollToElement(page, "//h3[text()='Isolation Forest Anomaly Detection']");
            return await WaitForElementVisible(page, "//div[@id='isolationForecastDataDiv']", 120000);
        }
