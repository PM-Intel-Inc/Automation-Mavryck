...
namespace Mavryck_System.Tests.VivclimaTests_mavryck
{
    ...
    public class PatternRecognition_VivclimaTest_mavryck : Base
    {
        ...
        [Test]
        public async Task Vivclima_Verify_PageTitles_WithTooltips_OF_PatternRecognition()
        {
            ...
            try
            {
                ...
                await VivclimaPage_mavryck.VerifyPageTitleWithTooltip_PatternRecognition();
            }
            catch (Exception e)
            {
