    ...
    public class Predictions_VivclimaTest_mavryck : Base
    {
        ...
        public async Task Predictions_Verify_PageTitles_WithTooltips()
        {
            ...
            try
            {
                ...
                await VivclimaPage_mavryck.VerifyPageTitleWithTooltip_Predictions();
            }
            catch (Exception e)
            {
        ...
        {
            var Test = Extent.CreateTest("Predicitons (Recommendations):  Verify The Text Allignment Of Carbon After Column");
            int step = 0;
            ArrayList testSteps = new();
            var loginPage_mavryck = new LoginPage_mavryck(page, Test);
            var EnterpriseProjectPage_mavryck = new EnterpriseProjectPage_mavryck(page, Test);
